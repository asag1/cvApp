...
public class ContactService {
    ...
    void updateContact(int id, ContactView updatedContactView) {
        ...
        if (updatedContactView.getLink() != null) {
            contact.setLink(updatedContactView.getLink());
        }
    ...
    private ContactView mapToView(Contact contact) {
        return new ContactView(contact.getId(), contact.getValue(), contact.getType(), contact.getLink());
    }

    private Contact mapFromView(ContactView contactView) {
        return new Contact(contactView.getValue(), contactView.getType(), contactView.getLink());
    }
}
